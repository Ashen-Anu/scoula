...
class OwnerReset extends StatefulWidget {
  const OwnerReset({super.key});

  @override
  State<OwnerReset> createState() => _OwnerResetState();
}

class _OwnerResetState extends State<OwnerReset> {
  ...
  void signUpuser() async {
    if (emailController.text.isNotEmpty &&
      ...
      if (jsonResponse['status']) {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => OwnerReset()));
      } else {
