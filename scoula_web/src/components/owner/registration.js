...
import { registerOwner } from "../../helper/helper";
...
const OwnerRegistration= () =>
{
    ...
    const formik= useFormik({
        ...
        onSubmit:async values =>{
            let registerPromise= registerOwner(values)
            ...
            registerPromise.then(function(){navigate('/ownerLoginEmail')})
        }
    })
    return (
        <div className="bgcol">
        ...
        <div className="cover">
            ...
            <span className="text-gray-500">Already have an account? <Link className="text-red-500"  to="/ownerLoginEmail">Login Now</Link></span>
            </form> 
